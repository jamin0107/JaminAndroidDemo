...
public abstract class BaseModel implements Serializable {
	...
	final <T extends BaseModel> List<T> getModels(Cursor cursor) throws JsonSyntaxException, IllegalArgumentException, IllegalAccessException, InstantiationException {
							...
							if (field != null) {
								...
								if (dbField != null) {
									...
									if (type == long.class ){
										...
										boolean boolValue = cursor.getInt(columnIndex) > 0;
