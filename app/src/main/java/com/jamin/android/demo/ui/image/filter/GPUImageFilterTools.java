...
public class GPUImageFilterTools {  
    public static void showDialog(final Context context,
        ...
        filters.addFilter("Lookup (PINK)", FilterType.LOOKUP_PINK);
    ...
    private static GPUImageFilter createFilterForType(final Context context, final FilterType type) {
        switch (type) {
            ...
            case TONE_CURVE:
            	List<GPUImageFilter> filtersList = new LinkedList<GPUImageFilter>();
            	
    			filtersList.add(new GPUImageSaturationFilter(0.0f));

//    			filter = new GPUImageOverlayBlendFilter();
//    			filter.setBitmap(ImageLoader.decodeResource(
//    					mContext.getResources(),
//    					R.drawable.roidapp_imagelib_shadow_lit, textureLen, textureLen * textureLen));
//    			filtersList.add(filter);

    			GPUImageToneCurveFilter toneCurveFilter = new GPUImageToneCurveFilter();
    			toneCurveFilter.setFromCurveFileInputStream(context.getResources().openRawResource(R.raw.bw));
    			filtersList.add(toneCurveFilter);
            	
                return new GPUImageFilterGroup(filtersList);
            ...
            case LOOKUP_AMATORKA:
                ...
                return amatorka;
            case LOOKUP_PINK:
                GPUImageLookupFilter pink = new GPUImageLookupFilter();
                pink.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.mipmap.lookup_color_pink_lip_table));
                return pink;
            case GAUSSIAN_BLUR:
...
//                return new GPUImageColorBalanceFilter();
    ...
    private enum FilterType {
        ...
        BLEND_COLOR, BLEND_HUE, BLEND_SATURATION, BLEND_LUMINOSITY, BLEND_LINEAR_BURN, BLEND_SOFT_LIGHT, BLEND_SUBTRACT, BLEND_CHROMA_KEY, BLEND_NORMAL, LOOKUP_AMATORKA,LOOKUP_PINK,
